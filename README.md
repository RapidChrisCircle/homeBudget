...
|---|---|
| Date | From / To, **inclusive on both ends** |
...
| Debit **and** Credit | the **same** Min/Max amount filter — **positive dollars** compared against the absolute value of the debit or credit — set from either header, reflected on both |
